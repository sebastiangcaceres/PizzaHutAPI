...
using PizzaHutAPI.Infrastructure.Files;
using PizzaHutAPI.Infrastructure.Identity;
using PizzaHutAPI.Infrastructure.Persistence;
using PizzaHutAPI.Infrastructure.Services;
using PizzaHutAPI.Infrastructure.Services.Handlers;
using System;
using System.Text;

namespace PizzaHutAPI.Infrastructure
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)//, IWebHostEnvironment environment)
        {
            ...
            var migrationAssembly = $"PizzaHutAPI.Infrastructure.{provider}";
