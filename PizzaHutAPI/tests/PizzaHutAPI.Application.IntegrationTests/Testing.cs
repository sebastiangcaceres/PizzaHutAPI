    ...
    public class Testing
    {
        ...
        public async Task RunBeforeAnyTestsAsync()
        {
            ...
            services.AddSingleton(Mock.Of<IWebHostEnvironment>(w =>
                ...
                w.ApplicationName == "PizzaHutAPI.Api"));
        ...
        private static async Task<string> RunAsUserAsync(string userName, string password, string[] roles)
        {
            ...
            var userManager = scope.ServiceProvider.GetService<UserManager<PizzaHutAPI.Infrastructure.Identity.ApplicationUser>>();

            var user = new PizzaHutAPI.Infrastructure.Identity.ApplicationUser { UserName = userName, Email = userName };
